...
public class MathTest {
    ...
    public void testConstrainOutOfRangeBelow() {
        assertEquals(4, Util.constrain(1, 4, 7));
    }

    @Test
    public void testConstrainOutOfRangeNegativeBelow() {
        assertEquals(-2, Util.constrain(-3, -2, 7));
    }

    @Test
    public void testConstrainOutOfRangeAbove() {
        assertEquals(7, Util.constrain(12, 4, 7));
    }

    @Test
    public void testConstrainOutOfRangeNegativeAbove() {
        assertEquals(-3, Util.constrain(-1, -7, -3));
    }

    @Test
    public void testConstrainInRange() {
        assertEquals(5, Util.constrain(5, 4, 7));
    }

    @Test
    public void testConstrainInRangeNegative() {
        assertEquals(-5, Util.constrain(-5, -7, -3));
    }
    ...
    public void testWrapBelow() {
        assertEquals(5, Util.wrap(2, 4, 7));
    }

    @Test
    public void testWrapAbove() {
        assertEquals(5, Util.wrap(8, 4, 7));
    }

    @Test
    public void testWrapUpperLimit() {
        assertEquals(4, Util.wrap(7, 4, 7));
    }

    @Test
    public void testWrapLowerLimit() {
        assertEquals(4, Util.wrap(4, 4, 7));
    }

    @Test
    public void testWrapNegativeBelow() {
        assertEquals(-6, Util.wrap(-9, -7, -4));
    }

    @Test
    public void testWrapNegativeAbove() {
        assertEquals(-5, Util.wrap(-2, -7, -4));
    }

    @Test
    public void testWrapNegativeUpperLimit() {
        assertEquals(-7, Util.wrap(-4, -7, -4));
    }

    @Test
    public void testWrapNegativeLowerLimit() {
        assertEquals(-7, Util.wrap(-7, -7, -4));
    }

    @Test
    public void testWrapEqualMinMax() {
        assertEquals(5, Util.wrap(-1, 5, 5));
    }
}
